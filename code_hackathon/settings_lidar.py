...
class Settings(BaseSettings):
    ...
    dmax: int = 5000  # max distance of plot in MM
    ...
    file_to_visualize = '/Users/tom.klaver/Downloads/auto_close.json'
    folder_to_save_plots = '/Users/tom.klaver/Downloads/testplots/'
...
def get_dynamo_db_configurations(settings):
